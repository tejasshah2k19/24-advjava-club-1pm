...
<body>
	...
	<div class="session">
		<div class="left">
			...
			<svg enable-background="new 0 0 300 302.5" version="1.1"
				viewBox="0 0 300 302.5" xml:space="preserve"
		...
		<form action="LoginServlet" method="post" class="log-in"
			autocomplete="off">
			<h4>
			...
			<div class="floating-label">
				...
				<div class="icon">
					...
					<?xml version="1.0" encoding="UTF-8"?>
					<svg enable-background="new 0 0 100 100" version="1.1"
...
<rect class="st0" width="100" height="100" />
			...
			<div class="floating-label">
				<input placeholder="Password" type="password" name="password"
					id="password" autocomplete="off"> <label for="password">Password:</label>
				<div class="icon">
		...
		<path class="st1"
			...
			<br>
			${error }
			<a href="https://codepen.io/elujambio/pen/yjwzGP" class="discrete"
